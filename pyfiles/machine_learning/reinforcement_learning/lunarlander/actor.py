...
class ActorNetwork(object):
    def __init__(self, sess, num_state, num_action, batch_size, tau, learning_rate):
        ...
        self.model, self.weights, self.state = self.create_network(num_state, 1)
        self.target_model, self.target_weights, self.target_state = self.create_network(num_state, 1)
